  ...
  return (
    <section className="reviews" id="reviews">
      <div className="reviews__header">
        ...
        <a href="#reviews" className="reviews__view-all">View All</a>
      </div>
      <div className="reviews__divider"></div>

      <div ref={trustindexRef} className="reviews__trustindex" aria-label="Live customer reviews">
      </div>

      <div className={`reviews__row ${trustindexReady ? 'reviews__row--fallback-hidden' : ''}`} data-reviews="">
        <button
          type="button"
